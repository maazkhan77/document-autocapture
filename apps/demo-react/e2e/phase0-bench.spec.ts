...
test('phase0 feasibility benchmark', async ({ page }, testInfo) => {
  ...
  await page.waitForFunction(() => Boolean((window as { __DOCUMENT_AUTOCAPTURE_PHASE0__?: unknown }).__DOCUMENT_AUTOCAPTURE_PHASE0__), {
    timeout: 180000,
  });

  const result = await page.evaluate(() => (window as { __DOCUMENT_AUTOCAPTURE_PHASE0__?: unknown }).__DOCUMENT_AUTOCAPTURE_PHASE0__);
